...
export default function RequestFriendButton({ friend }: { friend: User }) {
  ...
  const onSubmit = async () => {
    ...
    try {
      const result = await axios.post<PositiveAcceptRequestType>(
        "https://messengerbackend-production-d50f.up.railway.app/users/friend/request",
